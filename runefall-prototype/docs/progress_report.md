...
2. Add a short FTUE/tutorial pass: first-run movement, dash, switch, level-up, and fusion prompts.
3. Add meta-progression screens beyond placeholders: character detail, equipment/crafting, and shop mock flows.
4. Tune the 15-20 minute loop: stage pacing, reward amounts, boss difficulty, and fusion balance.
5. Replace remaining placeholder icons/sprites with final or higher-quality licensed pixel assets.
