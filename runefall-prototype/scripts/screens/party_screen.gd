...
static func show(main) -> void:
	...
	main.button(root, "← 홈", Vector2(32, 26), Vector2(112, 48), Callable(main, "show_home"), 20, Color("#26334d"), "button_blue")
	...
	main.button(root, "전용 장비 보기", Vector2(706, 526), Vector2(160, 42), Callable(main, "show_message").bind("전용 장비 슬롯은 다음 구현 단계에서 연결합니다."), 18, Color("#33415c"), "button_blue")
	...
	main.button(root, "출격 확인으로", Vector2(1190, 718), Vector2(290, 72), Callable(main, "show_launch_confirm"), 26, Color("#f05a28"), "button_red")
...
static func show_launch_confirm(main) -> void:
	...
	bg.color = Color("#0d1424")
	root.add_child(bg)
	main.button(root, "← 편성", Vector2(32, 26), Vector2(124, 48), Callable(main, "show_party"), 20, Color("#26334d"), "button_blue")
	...
	main.button(root, "전투 시작", Vector2(1196, 720), Vector2(300, 76), Callable(main, "start_battle"), 30, Color("#f05a28"), "button_red")
