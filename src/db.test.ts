...
describe('getMessagesSince', () => {
  ...
  it('returns messages after the given timestamp', () => {
    ...
    // Should exclude m1, m2 (before/at timestamp); m3 (bot) and m4 included
    expect(msgs).toHaveLength(2);
    expect(msgs[0].content).toBe('bot reply');
    expect(msgs[1].content).toBe('third');
  });

  it('includes bot messages for bot-collaboration mode', () => {
    const msgs = getMessagesSince(
      'group@g.us',
      '2024-01-01T00:00:00.000Z',
      'Andy',
...
describe('getNewMessages', () => {
  ...
  it('returns new messages across multiple groups', () => {
    ...
    // Includes bot message, returns 4 messages total
  ...
  it('filters by timestamp', () => {
    ...
    // g1 msg2 + bot message (both after ts)
